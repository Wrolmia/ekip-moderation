...
if(!message.member.roles.cache.has(ayarlar.yetkilirol) && !message.member.roles.cache.has(ayarlar.kayıtcırol) && !message.member.hasPermission("ADMINISTRATOR")) return;
